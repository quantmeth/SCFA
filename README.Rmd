...
The library `SCFA` is an **R** implementation of the Signal Cancelling Factor Analysis (SCFA) developped by @Achim24. It provides a main function `SCFA()` to carry the analysis. Currently in development.
...
Caron, P.-O. (2023). *SCFA: Signal Cancelling Factor Analysis*. https://github.com/quantmeth/SCFA
